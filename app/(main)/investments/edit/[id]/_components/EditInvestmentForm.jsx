...
export default function EditInvestmentForm({ investment }) {
  ...
  const {
    ...
    defaultValues: {
      ...
      subCategoryId: investment.subCategoryId || "",
  ...
  return (
    <div className="container mx-auto max-w-5xl flex justify-center items-center min-h-screen p-3">
      <Card className="w-full shadow-lg">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Edit Investment</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                defaultValue={investment.categoryId || "none"}
              >
                <SelectTrigger>
            ...
            {selectedCategoryId && selectedCategoryId !== "none" && (
              <div className="space-y-2">
                ...
                <Select
                  ...
                  defaultValue={investment.subCategoryId || "none"}
                >
                  <SelectTrigger>
