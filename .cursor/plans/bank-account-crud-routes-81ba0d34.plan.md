<!-- 81ba0d34-19a4-4171-b0b1-9c6c30f2507d f2adbbe6-f4da-4d1f-9d4e-0c3dbd2b9139 -->
...
- [ ] Create API routes: app/api/transactions/route.js (GET with filters, POST), app/api/transactions/[id]/route.js (GET, PATCH, DELETE), app/api/transactions/export/route.js (CSV export)
- [ ] Add transaction schemas to lib/formSchema.js: transactionSchema, updateTransactionSchema, transactionFilterSchema
- [ ] Create app/(main)/transactions/_components/FilterPanel.jsx with all filter options (date range, bank account, category, type, status, payment method, amount range, search, sort)
- [ ] Create app/(main)/transactions/_components/TransactionTable.jsx with columns, pagination, actions, and responsive design
- [ ] Create app/(main)/transactions/_components/TransactionStats.jsx with statistics cards and charts showing filtered data stats
- [ ] Create app/(main)/transactions/_components/ExportButton.jsx for CSV export functionality
- [ ] Update app/(main)/transactions/page.jsx to integrate FilterPanel, TransactionTable, TransactionStats, and ExportButton
- [ ] Update app/(main)/transactions/add/page.jsx to use new transaction schema and POST /api/transactions
- [ ] Update app/(main)/transactions/details/[id]/page.jsx to fetch from GET /api/transactions/[id] and display details
- [ ] Create app/(main)/transactions/edit/[id]/page.jsx with edit form that uses PATCH /api/transactions/[id]